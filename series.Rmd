...
https://github.com/GLDDavid/mon_livre.git
...
9. Type git remote add monlivre https://github.com/GLDDavid/mon_livre.git
10. Type `git push --set-upstream monlivre master`
...
setwd("C:/Users/Cefim/Desktop/cours data/cours_R/TP_R_Cefim")
